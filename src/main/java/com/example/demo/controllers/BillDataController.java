...
//            double max;
//            if (!fixedValue){
//                min = Math.min(amount - 5, amount - 0.05 * amount);
//                max = Math.max(amount + 5, amount + 0.05 * amount);
//            }
//            else {
...
//    }
    ...
    public boolean predict(List<BillData> billDataList, int k, BillData billData){
